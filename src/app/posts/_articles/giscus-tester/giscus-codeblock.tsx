      ...
      >
        ...
        >
          ...
          <span>
            ...
            <span style={textStyle('#96D0FF', '#032F62')}>&#39;{repository}&#39;</span>
            <span style={textStyle('#ADBAC7', '#24292E')}>,</span>
          </span>
          <span>
            <span style={textStyle('#ADBAC7', '#24292E')}>{'  '}REPO_ID: </span>
            <span style={textStyle('#96D0FF', '#032F62')}>&#39;{repositoryId}&#39;</span>
            <span style={textStyle('#ADBAC7', '#24292E')}>,</span>
          </span>
          <span>
            <span style={textStyle('#ADBAC7', '#24292E')}>{'  '}CATEGORY: </span>
            <span style={textStyle('#96D0FF', '#032F62')}>&#39;{category}&#39;</span>
            <span style={textStyle('#ADBAC7', '#24292E')}>,</span>
          </span>
          <span>
            <span style={textStyle('#ADBAC7', '#24292E')}>{'  '}CATEGORY_ID: </span>
            <span style={textStyle('#96D0FF', '#032F62')}>&#39;{categoryId}&#39;</span>
            <span style={textStyle('#ADBAC7', '#24292E')}>,</span>
          </span>
          <span>
